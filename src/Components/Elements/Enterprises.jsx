...
<div class="container ">
        <div class="row">
          <div class="col-md-6 col-12 fluid images">
            <img className="image-fluid" data-aos="fade-down-right" src="Assests/home.svg" alt="" width="90%" />
          </div>

          <div class="col-md-6 col-12 images ">
            <div className="text-start  ">
              <p className=" font1 " data-aos="fade-down-right">
                <b> Built for enterprises</b>{" "}
              </p>{" "}
              &nbsp;&nbsp;&nbsp;&nbsp;
              <p className=" font2" data-aos="fade-down-right">
              ...
              <button type="button" className="btn " data-aos="fade-down-right">
                <b> Find out more</b>
              </button>
            </div>
          </div>
